...
def show_page():
  ...
  show_cnn_global_interpretability = st.checkbox("Show CNN model important features for model ouputs")
  ...
  with st.expander("Multiple classification"):
    ...
    if show_dnn_multiple: 
      ...
      show_dnn_multiple_architecture = st.checkbox("Show DNN multiple architecture")
      ...
      if show_dnn_multiple_model_train:
        st.image(st.session_state.images.get('mit-dnn-multiple-model-loss-by-epoch'))
        st.image(st.session_state.images.get('mit-dnn-multiple-model-accuracy-by-epoch'))
    ...
    if show_lstm_multiple: 
      st.write('## LSTM')
      show_lstm_multiple_architecture = st.checkbox("Show LSTM multiple architecture")
      if show_lstm_multiple_architecture: 
        st.image(st.session_state.images.get('mit-lstm-architecture'))
        
      show_lstm_multiple_model_train = st.checkbox("show LSTM multiple model train")
      if show_lstm_multiple_model_train:
        st.image(st.session_state.images.get('mit-lstm-multiple-model-loss-by-epoch'))
        st.image(st.session_state.images.get('mit-lstm-multiple-model-accuracy-by-epoch'))
    ...
    if show_cnn_multiple: 
      st.write('## LSTM')
      show_cnn_multiple_architecture = st.checkbox("Show CNN multiple architecture")
      ...
      if show_cnn_multiple_model_train:
        st.image(st.session_state.images.get('mit-cnn-multiple-model-loss-by-epoch'))
        st.image(st.session_state.images.get('mit-cnn-multiple-model-accuracy-by-epoch'))
  ...
  with st.expander("Binary classification"):
    ...
    if show_dnn_binary: 
      ...
      show_dnn_binary_architecture = st.checkbox("Show DNN binary classification architecture")
      ...
      if show_dnn_binary_model_train:
        st.image(st.session_state.images.get('mit-dnn-binary-model-loss-by-epoch'))
        st.image(st.session_state.images.get('mit-dnn-binary-model-accuracy-by-epoch'))
    ...
    if show_lstm_binary: 
      st.write('## LSTM')
      show_lstm_binary_architecture = st.checkbox("Show LSTM binary classification architecture")
      ...
      if show_lstm_binary_model_train:
        st.image(st.session_state.images.get('mit-lstm-binary-model-loss-by-epoch'))
        st.image(st.session_state.images.get('mit-lstm-binary-model-accuracy-by-epoch'))
    ...
    if show_cnn_binary: 
      ...
      if show_cnn_binary_model_train:
        st.image(st.session_state.images.get('mit-cnn-binary-model-loss-by-epoch'))
        st.image(st.session_state.images.get('mit-cnn-binary-model-accuracy-by-epoch'))
